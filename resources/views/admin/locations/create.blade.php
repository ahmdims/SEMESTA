                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="name" class="form-control mb-2"
                                            placeholder="Enter location name" value="{{ old('name') }}" required>
                                        @error('name')
                                    ...
                                    <div class="row g-6 mb-10">
                                        <div class="col fv-row">
                                            ...
                                            <input type="text" name="latitude" class="form-control mb-2"
                                                placeholder="Example: -7.2575" value="{{ old('latitude') }}" required>
                                            @error('latitude')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col fv-row">
                                            ...
                                            <input type="text" name="longitude" class="form-control mb-2"
                                                placeholder="Example: 112.7521" value="{{ old('longitude') }}" required>
                                            @error('longitude')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="number" name="radius" class="form-control mb-2"
                                            placeholder="Example: 30" value="{{ old('radius', 30) }}" required>
