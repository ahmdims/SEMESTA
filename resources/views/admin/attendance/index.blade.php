                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <thead class="bg-gray-50">
                                    <tr class="text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-start min-w-150px">Latitude</th>
                                        <th class="text-start min-w-150px">Longitude</th>
                                        <th class="text-start min-w-100px">Radius (m)</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($locations as $key => $location)
                                        <tr>
                                            ...
                                            <td class="text-start pe-0">{{ $location->latitude }}</td>
                                            <td class="text-start pe-0">{{ $location->longitude }}</td>
                                            <td class="text-start pe-0">{{ $location->radius }}</td>
                                            <td class="text-end">
                                                <a href="#"
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3"
                                                            onclick="location.preventDefault(); if(confirm('Are you sure you want to delete this event?')) { document.getElementById('delete-event-{{ $location->id }}').submit(); }">Delete</a>
                                                        <form id="delete-event-{{ $location->id }}"
